...
let ConnectionContext = class ConnectionContext {
    constructor() {
        this._ntlmState = 0 /* NtlmStateEnum.NotAuthenticated */;
    ...
    canStartAuthHandshake(ntlmHostUrl) {
        const auth = this._ntlmHost === undefined ||
            (this._ntlmHost.href === ntlmHostUrl.href &&
                (this._ntlmState === 4 /* NtlmStateEnum.Authenticated */ || this._ntlmState === 0 /* NtlmStateEnum.NotAuthenticated */));
        return auth;
    }
    matchHostOrNew(ntlmHostUrl, isSSL) {
    ...
    getState(ntlmHostUrl) {
        ...
        return 0 /* NtlmStateEnum.NotAuthenticated */;
    }
